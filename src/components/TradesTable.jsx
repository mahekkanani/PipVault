...
export default function TradesTable({ trades, sortConfig, onSort, onEdit, onDelete, onPreview }) {
  return (
                  ...
                  >
                    <td className="px-4 py-3">
                      {trade.screenshot ? (
                        ...
                        >
                          <img src={trade.screenshot} alt={`${trade.pair} screenshot`} className="h-full w-full object-cover" />
                        </button>
                      ) : (
                    ...
                    <td className="whitespace-nowrap px-4 py-3 text-zinc-300">{trade.emotion}</td>
                    ...
                    <td className="whitespace-nowrap px-4 py-3">
                      <div className="flex justify-end gap-2">
                        <Button variant="secondary" className="h-9 w-9 p-0" onClick={() => onEdit(trade)} aria-label="Edit trade">
                          <Edit3 size={16} />
                        </Button>
                        <Button variant="danger" className="h-9 w-9 p-0" onClick={() => onDelete(trade.id)} aria-label="Delete trade">
                          <Trash2 size={16} />
                        </Button>
                      </div>
                    </td>
